...
export default function NotificationSidePopout(notificationList: NotificationList) {
  return (
    <div className="h-[832px] w-[503px] p-[32px] border-2 rounded-3xl gap-[16px] bg-[#F5EADD] border-[#756859] rounded-r-none">
      ...
      <div className="flex flex-col justify-items-center h-[605px]">
        {mapNotifications(true, notificationList.notificationList)}
      </div>
    </div>
  );
}

function mapNotifications(read: boolean, notificationList: Notification[]) {
  return (
